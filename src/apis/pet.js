...
var fetchPetData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, axios_1.default.get("http://apis.data.go.kr/1543061/abandonmentPublicService_v2/abandonmentPublic_v2", {
                        params: {
            ...
            case 2:
                ...
                savePetsToDB = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var currentYear, deleteError, _i, pets_2, pet, ageMatch, ageYear, calculatedAge, weightMatch, calculatedWeight, error;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 2:
                                ...
                                calculatedWeight = weightMatch
                                    ...
                                    : null;
                                return [4 /*yield*/, supabase.from("list").insert([
                                        {
            ...
            case 4:
                ...
                if (axios_1.default.isAxiosError(error_1) && error_1.response) {
                    if (error_1.response.status === 429) {
                        ...
                        console.error("API 요청 오류:", error_1.response.status, error_1.response.statusText);
                    }
                }
                else {
